...
# Django settings for yugteatr project.
...
SECRET_KEY = 'os#uw1%go#0nurrhhd#(vc2ijore0h+kkej#99nu*)b3*pmxk%'
...
ROOT_URLCONF = 'yugteatr.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'yugteatr.wsgi.application'
